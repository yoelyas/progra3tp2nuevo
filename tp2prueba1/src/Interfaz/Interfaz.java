...
public class Interfaz {
	...
	private void initialize() {
		...
		btnCrearArco.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				grafo.nuevoArco(textFieldPrimerVertice.getText(), textFieldSegundoVertice.getText(), Integer.parseInt(textFieldPesoArco.getText()));
		...
		tableMatriz.setModel(new DefaultTableModel(
			new Object[][] {
			},
			new String[] {
			}
